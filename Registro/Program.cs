...
options => options.UseSqlServer("Data Source=sqldata;Initial Catalog= Usuarios;User ID=SA;Password=Thomas.19983;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False"));
